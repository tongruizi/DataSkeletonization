...
//get y←BY(y,5r/3)\BY(y,r)
    ...
    std::string outt = "/home/yury/LocalTests/OutputMetricGraphRec/debugcolor.csv";
    ...
    std::string outt2 = "/home/yury/LocalTests/OutputMetricGraphRec/debugcolorActual.csv";
